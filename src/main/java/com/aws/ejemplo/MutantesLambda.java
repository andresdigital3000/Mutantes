 ...
 */
public class MutantesLambda implements RequestHandler<RequestDTO, ResponseDTO> {
    public ResponseDTO handleRequest(RequestDTO requestDTO, Context context) {
        ...
        //Insert code for Mutants
        if (isMutant(requestDTO.getDna())) {
            responseDTO.setCode("200");
            responseDTO.setMessage("OK");
            responseDTO.setResponseInsertDTO(mutanteDAO.insertStatsMutant());
        } else {
            responseDTO.setCode("403");
            responseDTO.setMessage("Forbidden");
            responseDTO.setResponseInsertDTO(mutanteDAO.insertStatsHumans());
        }
        return responseDTO;
